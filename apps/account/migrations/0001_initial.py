    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=254, null=True, region=None, unique=True, validators=[apps.account.validators.validate_possible_number], verbose_name='phone number')),
